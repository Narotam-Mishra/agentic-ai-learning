...
@traceable(name="build_vectorstore", tags=['embeddings', 'vector_store'], metadata={'embedding_model': 'text-embedding-3-small'})
...
# we can also trace a “setup” umbrella span if you want:
