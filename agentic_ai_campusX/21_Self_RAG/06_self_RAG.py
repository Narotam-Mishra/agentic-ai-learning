...
# self RAG (Testing Answer Usefulness)
...
class State(TypedDict):
    ...
    # max retries for loop
    retries: int

    # answer's usefulness check
...
class RelevanceDecision(BaseModel):
    is_relevant: bool = Field(
        ...,
        description=(
            "True if the document discusses the same entity or topic area as the "
            "question; it need not contain the complete answer."
        )
    )
...
rag_generation_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "If the requested information is absent, say so clearly. "
...
def no_answer_found(state: State):
    return {
        "answer": "No answer found in the available company documents.",
        "context": "",
        # This node is reached before the IsSUP and IsUSE nodes, so populate
        # their output fields explicitly instead of leaving misleading blanks.
        "issup": "no_support",
        "evidence": [],
        "isuse": "not_useful",
        "use_reason": "No relevant source content was found for the question.",
    }
...
# -----------------------------
initial_state = {
    "question": "What is relocation policy of NexaAI",
    "docs": [],
    "relevant_docs": [],
    "context": "",
    "answer": "",
