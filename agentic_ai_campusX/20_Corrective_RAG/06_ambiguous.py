...
# iteration 1 - basic RAG (load, chunk, index, retrieve, and generate)
...
# iteration 2 - retrieval refinement (decompose, filter, and recompose context)
...
# iteration 3 - retrieval evaluator (classify retrieval as correct, incorrect, or ambiguous)
...
# iteration 4 - query re-writing for web search
...
# iteration 5 - web search using tavily
# web search node: use web_query
...
def web_search_node(state: State) -> State:
    ...
    # TavilySearch currently returns a wrapper such as:
    # {"query": ..., "results": [{"title": ..., "url": ..., "content": ...}]}
    # Older/different integrations may return the result list directly.
